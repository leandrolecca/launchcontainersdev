...
[Code of Conduct Enforcement Team](https://launchcontainers.readthedocs.io/en/stable/governance.html#leadership):
...
necessary for the safety of the `launchcontainers` community, including but not
limited to:
...
* asking a contributor to no longer participate in the development of `launchcontainers`

For more details on the enforcement process, please see our documentation
on [governance](https://launchcontainers.readthedocs.io/en/stable/governance.html).
