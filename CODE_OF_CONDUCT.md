...
[Code of Conduct Enforcement Team](https://rtp.readthedocs.io/en/stable/governance.html#leadership):
...
necessary for the safety of the `rtp` community, including but not
limited to:
...
* asking a contributor to no longer participate in the development of `rtp`

For more details on the enforcement process, please see our documentation
on [governance](https://rtp.readthedocs.io/en/stable/governance.html).
