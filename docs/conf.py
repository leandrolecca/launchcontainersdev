...
# -*- coding: utf-8 -*-
#
# launchcontainers documentation build configuration file, created by
# sphinx-quickstart
#
...
author = "launchcontainers Developers"
...
linkcode_resolve = make_linkcode_resolve(
    "launchcontainers",
    "https://github.com/launchcontainers/launchcontainers/blob/{revision}/{package}/{path}#L{lineno}",
)
